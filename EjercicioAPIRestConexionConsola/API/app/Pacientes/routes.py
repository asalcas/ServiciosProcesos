...
def leerFicherosPacientes():
    archivo = open("C:\\Users\\alvar\\Desktop\\DAM\\ServiciosProcesos\\EjercicioAPIRestConexionConsola\\API\\DB\\pacientes.json", "r")
...
def escribirFicherosPacientes(Pacientes):
    archivo = open("C:\\Users\\alvar\\Desktop\\DAM\\ServiciosProcesos\\EjercicioAPIRestConexionConsola\\API\\DB\\pacientes.json", "w")
