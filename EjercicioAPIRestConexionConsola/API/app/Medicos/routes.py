...
def leerFicherosMedicos():
    archivo = open("C:\\Users\\alvar\\Desktop\\DAM\\ServiciosProcesos\\EjercicioAPIRestConexionConsola\\API\\DB\\medicos.json", "r")
    Medicos = json.load(archivo)
    archivo.close()
    return Medicos

def escribirFicherosMedicos(Medicos):
    archivo = open("C:\\Users\\alvar\\Desktop\\DAM\\ServiciosProcesos\\EjercicioAPIRestConexionConsola\\API\\DB\\medicos.json", "w")
